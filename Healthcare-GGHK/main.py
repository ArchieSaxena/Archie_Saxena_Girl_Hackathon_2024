    ...
    try:
        ...
        # if True:
            ...
            if symptoms =="Symptoms":
                ...
                precautions_list = precautions[0].tolist()
                medications_list = eval(medications[0])
                rec_diet_list = eval(rec_diet[0])
                predicted_disease = diseases_list2[predicted_disease]
                ...
                # return jsonify(response_data), 200
                return jsonify({"data":{"predicted_disease":predicted_disease,"dis_des":dis_des,"precautions":precautions_list,"rec_diet_list":rec_diet_list,"medications_list":medications_list}})
